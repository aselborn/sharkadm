...
/**
 * Import format for Greyseal.
 * 
 */
public class FormatFileGreyseal extends FormatFileBase {

	public FormatFileGreyseal(PrintStream logInfo, FileImportInfo importInfo) {
	...
	public void importFiles(String zipFileName, Dataset dataset) {
		...
		loadKeyTranslator(importMatrixColumn, "import_matrix_greyseal.txt");
...
//				+ getCellByKey(row, "visit.county") + ":"
//				+ getCellByKey(row, "visit.reported_station_name") + ":"
//				+ getCellByKey(row, "visit.subsite");
		String keyString = getCellByKey(row, "visit.visit_date") + ":"
...
//		visit.addField("visit.visit_year", utils.convNoDecimal(visit
//				.getField("visit.visit_year")));
//		visit.addField("visit.visit_date", utils.convDate(visit
//				.getField("visit.visit_date")));
	}
