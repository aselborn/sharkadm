...
/**
 * Import format for Sedimentation.
 * 
 */
public class FormatFileSedimentation extends FormatFileBase {

	public FormatFileSedimentation(PrintStream logInfo, FileImportInfo importInfo) {
	...
	public void importFiles(String zipFileName, Dataset dataset) {
		...
		loadKeyTranslator(importMatrixColumn, "import_matrix_sedimentation.txt");
